defmodule Fountain.MixProject do
  ...
  defp unused_config do
    [
      # Not MixUnused.Analyzers.Private: "public but only called from its own
      # module" is hygiene, not dead code, and it is ~350 lines of the report.
      checks: [MixUnused.Analyzers.Unused, MixUnused.Analyzers.RecursiveOnly],
      ignore: [
